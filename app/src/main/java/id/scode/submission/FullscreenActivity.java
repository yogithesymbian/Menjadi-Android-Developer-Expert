...
// judulBukuContent = findViewById(R.id.fullscreen_content);
        ...
        String srcText = "Img Source : " +bookSubmission.getSpoiler();
        link.setText(srcText);

        String title = "" +bookSubmission.getJudulBuku();
        judul.setText(title);

        String detailBukunya = "" +bookSubmission.getDetailBuku();
        detailBook.setText(detailBukunya);

        String photo = getIntent().getStringExtra(EXTRA_IMG);
        Glide.with(this)
                .load(photo)
                .into(imgBuku);

        //END OF for pojo data ===========================================

//        imgBuku.setImageURI(Uri.parse(bookSubmission.getSpoiler()));

        mVisible = true;
        mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = findViewById(R.id.fullscreen_content); //this for titile too
        ...
        findViewById(R.id.dummy_button_harga).setOnTouchListener(mDelayHideTouchListener);
    }
